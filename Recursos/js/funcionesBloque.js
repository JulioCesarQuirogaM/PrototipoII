function bloques(){    
    ...
    var dt = $("#tablaBloque").DataTable({
            "ajax": "./Controlador/controladorBloque.php?accion=listar",
            "columns": [
                { "data": "bloque_ID"},
                { "data": "unidadres_Nomb"},
                { "data": "bloque_Descrip"},
    ...
    $("#editar").on("click",".btncerrar", function(){
        $(".box-title").html("Listado de Bloques");
    ...
    $(".box").on("click","#nuevo", function(){
        $(this).hide();
        $(".box-title").html("Crear Bloque");
        $("#editar").addClass('show');
        $("#editar").removeClass('hide');
        $("#listado").addClass('hide');
        $("#listado").removeClass('show');
        $("#editar").load('./Vistas/bloque/nuevoBloque.php', function(){
            $.ajax({
               type:"get",
            ...
            dataType:"json"
              ...
              if(resultado.respuesta){
                swal({
                    position: 'center',
                    type: 'success',
                    title: 'El Bloque fue grabado con éxito',
    ...
    $(".box-body").on("click","a.editar",function(){
       ...
       $("#listado").addClass('hide');
       $("#listado").removeClass('show');
       $("#editar").load("./Vistas/bloque/editarBloque.php",function(){
            $.ajax({
                type:"get",
                url:"./Controlador/controladorBloque.php",
                data: {codigo: codigo, accion:'consultar'},
                dataType:"json"
                }).done(function( bloque ) {        
                    if(bloque.respuesta === "no existe"){
                        swal({
                        type: 'error',
                        title: 'Oops...',
                        text: 'bloque no existe!'                         
                        })
                    } else {
                        $("#bloque_ID").val(bloque.codigo);
                        unidades = bloque.unidades;                   
                        $("#bloque_Descrip").val(bloque.bloque_Des);
