...
<head>
  ...
  <title>Prototipo 2 &mdash; Gestion Residencias </title>
...
<body  background="images/Hr.jpg" class="img-responsive">
  <div class="login-box">

    <div class="login-box-body">
      <div class="login-logo">
        <a href="#"><b>Admin</b>SGR</a>
      </div>
      <!-- /.login-logo -->
      <cite size="10">  <p class="login-box-msg">Inciar Sesión</p> </cite>
      ...
      <form id="login-form" action="" method="post">
        ...
        <div class="form-group has-feedback">
          ...
          <div class="row">
            <div class="col-xs-8">
              <center> <p class="mt-md"><a href="index.html" class="btn btn-special btn-block">Regresar</a></p> </center> 
            </div>
            <!-- /.col -->
            <div class="col-xs-4">
