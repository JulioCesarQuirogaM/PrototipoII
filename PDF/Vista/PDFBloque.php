...
function Header()
{
    ...
    $this->Cell(40);
    // Título
    $this->Cell(150,10,'SISTEMA GESTION DE UNIDADES',0,0,'L');
    $this->Ln(20);
    //Subtitulo
    $this->Cell(100,5,'Reporte Bloques',0,0,'L');
    // Salto de línea
    $this->Ln(10);
...
function cargarDatos()
{
   ...
   $apartamento = new Bloque();
$listado = $apartamento->listaBloque();
return $listado;
}
...
$titulos = array('Codigo', 'unidad', 'bloque_Descrip', 'estado',);
// Carga de datos
