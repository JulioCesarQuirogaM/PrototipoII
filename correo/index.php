    ...
    <section class="form_wrap">
        ...
        <section class="cantact_info">
            ...
            <section class="info_items">
                <p><span class="fa fa-envelope"></span> info.adminSRG@gmail.com</p>
                <p><span class="fa fa-mobile"></span> +1(310) 567-5555</p>
            </section>
        </section>

        <form action="correo/enviar.php" method="post" class="form_contact">
