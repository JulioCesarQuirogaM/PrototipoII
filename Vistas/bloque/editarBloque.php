            ...
            <div class="panel-body">    
                <form class="form-horizontal" role="form"  id="fbloque">
 					<div class="form-group">
                        <label class="control-label col-sm-2" for="bloque_ID">Codigo:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="bloque_Descrip">Bloque:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="bloque_Descrip" name="bloque_Descrip" placeholder="Ingrese La Zona Publicaa"
                            value = "">
                        </div>
                    </div>	
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="actualizar" class="btn btn-primary" data-toggle="tooltip" title="Actualizar Bloque">Actualizar</button>
