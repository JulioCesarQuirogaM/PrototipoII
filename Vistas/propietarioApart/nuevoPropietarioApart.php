    ...
    <div class="box-body">
        <div class="panel-group"><div class="panel panel-primary">
          ...
          <div class="form-group">
                        <label class="control-label col-sm-1" for="propietarioApart_ID">Codigo:</label>
           ...
           <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="grabar" class="btn btn-primary" data-toggle="tooltip" title="Grabar Propietario">Grabar</button>
