            ...
            <div class="panel-body">    
                <form class="form-horizontal" role="form"  id="fzonaP">
 					<div class="form-group">
                        <label class="control-label col-sm-1" for="zonaP_ID">Codigo:</label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-1" for="unidadres_ID">Unidad Resi:</label>
                        <div class="input-group col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-1" for="zonaP_Descrip">Zona Publica:</label>
                        <div class="input-group col-sm-10">
                            <span class="input-group-addon"><i class="fas fa-building"></i></span>
                            <input type="text" class="form-control" id="zonaP_Descrip" name="zonaP_Descrip" placeholder="Nombre Zona Publica"
                            value = "">
                        </div>                    
                    </div>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="grabar" class="btn btn-primary" data-toggle="tooltip" title="Grabar Zona">Grabar</button>
