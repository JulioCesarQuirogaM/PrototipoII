            ...
            <div class="panel-body">    
                <form class="form-horizontal" role="form"  id="fapart">
 					<div class="form-group">
                        <label class="control-label col-sm-1" for="apart_ID">Codigo:</label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-1" for="apart_Sigla">Apartamento:</label>
                        <div class="input-group col-sm-10">
                            <span class="input-group-addon"><i class="fas fa-building"></i></span>
                            <input type="text" class="form-control" id="apart_Sigla" name="apart_Sigla" placeholder="Sigla Apartamento"
                            value = "">
                        </div>                    
                    </div>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="grabar" class="btn btn-primary" data-toggle="tooltip" title="Grabar Apartamento">Grabar</button>
