    ...
    <div class="box-body">
        <div class="panel-group"><div class="panel panel-primary">
            ...
            <div class="panel-body">    
                <form class="form-horizontal" role="form"  id="fapart">
 					<div class="form-group">
                        <label class="control-label col-sm-2" for="apart_ID">Codigo:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="apart_ID" name="apart_ID" placeholder="Ingrese Codigo"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <option value="" selected>Seleccione ...</option>
                                <?php foreach($listaApartamento as $fila){ ?>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="apart_Sigla">Apartamento:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="apart_Sigla" name="apart_Sigla" placeholder="Ingrese La Zona Publicaa"
                            value = "">
                        </div>
                    </div>	
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="actualizar" class="btn btn-primary" data-toggle="tooltip" title="Actualizar Apartamento">Actualizar</button>
