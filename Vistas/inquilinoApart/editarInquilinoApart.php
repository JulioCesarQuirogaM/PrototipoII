            ...
            <div class="panel-body">    
                <form class="form-horizontal" role="form"  id="finquilinoApart">
 					<div class="form-group">
                        <label class="control-label col-sm-2" for="inquilinoApart_ID">Codigo:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="persona_ID">Inquilino:</label>
                        <div class="col-sm-10">
                    ...
                    <!--  -->	
					 ...
					 <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="actualizar" class="btn btn-primary" data-toggle="tooltip" title="Actualizar Inquilino">Actualizar</button>
