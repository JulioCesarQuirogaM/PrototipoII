            ...
            <div class="panel-body">    
                <form class="form-horizontal" role="form"  id="fpais">
 					<div class="form-group">
                        <label class="control-label col-sm-1" for="pais_ID">Codigo:</label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-1" for="pais_Nomb">Nombre:</label>
                        <div class="input-group col-sm-10">
                            <span class="input-group-addon"><i class="fas fa-building"></i></span>
                            <input type="text" class="form-control" id="pais_Nomb" name="pais_Nomb" placeholder="Nombre del Pais"
                            value = "">
                        </div>                    
                    </div>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="grabar" class="btn btn-primary" data-toggle="tooltip" title="Grabar">Grabar</button>
