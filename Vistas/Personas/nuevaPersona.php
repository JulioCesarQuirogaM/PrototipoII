                ...
                <form class="form-horizontal" role="form"  id="fpersona">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-10">
                            ...
                            <input type="text" class="form-control" id="sexo" name="sexo" placeholder="Ingrese la Inicial del Sexo de la Persona"
                            value = "">
                        </div>                    
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-10">
                            <span class="input-group-addon"><i class="fas fa-phone"></i></span>
                            <input type="text" class="form-control" id="persona_Cel" name="persona_Cel" placeholder="Ingrese el Numero Celular de la Persona"
                            value = "">
                        </div>                    
                    </div>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="grabar" class="btn btn-primary" data-toggle="tooltip" title="Guardar Persona">Guardar</button>
